 ...
 */
export function runNelderMead(f, x0, opts = {}) {
...
/**
 * Optimizer strategy that wraps Nelder-Mead for 1-D objectives by
 * lifting the scalar `objective` to a 1-D vector wrapper.
 */
...
export class NelderMeadOptimizer extends Optimizer {
  ...
  minimize(objective, lower, upper, initial) {
    return runNelderMead((x) => objective(x[0]), [initial || 0.5], {
      maxIter: 500,
    }).x[0];
  }
}
