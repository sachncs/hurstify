 ...
 */
export function runAdaptiveGridSearch(f, min, max, opts = {}) {
  ...
  return runBrent(f, a, bestX, b, tol);
}

/**
 * Optimizer strategy that wraps {@link runAdaptiveGridSearch} for 1-D
 * coarse-to-fine search.
 */
import {Optimizer} from './optimizer.js';

export class AdaptiveGridSearchOptimizer extends Optimizer {
  /** @override */
  minimize(objective, lower, upper, _initial) {
    return runAdaptiveGridSearch(objective, lower, upper).x;
  }
}
