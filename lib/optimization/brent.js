...
/**
 * Optimizer strategy that wraps {@link runBrent} for 1-D smooth
 * objectives. Polymorphically dispatched by `Hurstify` via the
 * `Optimizer` base class.
 */
import {Optimizer} from './optimizer.js';

export class BrentOptimizer extends Optimizer {
  /** @override */
  minimize(objective, lower, upper, initial) {
    return runBrent(objective, lower, initial, upper, 1e-5).x;
  }
}
