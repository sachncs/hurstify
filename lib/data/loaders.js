/**
 * @fileoverview Data loading utilities for hurstify experiments.
 *
 ...
 *
 * The split-line state machine in `splitCSVLine` understands double
 ...
 */
export function downsampleSeries(series, intervalMs) {
