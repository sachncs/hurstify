/**
 * @fileoverview Asymptotic-variance-based inference for hurstify.
 *
 ...
 *   scales coincide).
 */
export function getAsymptoticVariance(scaleA1, scaleA2, n, m) {
 ...
 *   scale choices).
 */
export function getStandardError(scaleA1, scaleA2, n, m) {
  return Math.sqrt(getAsymptoticVariance(scaleA1, scaleA2, n, m));
}
...
export function getConfidenceInterval(
  ...
  const se = getStandardError(scaleA1, scaleA2, n, m);
